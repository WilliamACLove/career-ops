...
> **Эта редакция ориентирована на карьеру в юриспруденции** — юристы юридических фирм, инхаус-юристы, комплаенс и регуляторная практика, юристы государственного сектора / общественных интересов и legal tech роли. Архетипы, список порталов, источники данных о компенсации и оценочные гейты (квалификация, соответствие грейду по стажу, конфликты интересов) ниже настроены под юридический рынок труда. Базовый движок универсален для любой карьеры и полностью настраивается под неё — просто попросите свой AI CLI изменить архетипы. Оригинальная редакция для AI/инженерных карьер, на основе которой построен этот проект, остаётся open source и поддерживается [santifer](https://santifer.io) (см. «Об авторе» ниже).
...
| **Сканер порталов**           | 45+ предустановленных компаний — legal tech (Harvey, Ironclad, Everlaw, Spellbook, Clio...), инхаус-юридические команды в tech-компаниях (Anthropic, OpenAI, Coinbase, Databricks, Stripe...), плюс российские площадки (hh.ru, trudvsem.ru, rabota.ru, Superjob и др.) — добавляются вручную в `portals.yml` |
...
Вставляешь URL вакансии или описание
        ...
        ▼
┌──────────────────┐
│  Определение     │  Классификация: юрист юрфирмы (транзакционная/
│  архетипа        │  судебная практика) / инхаус-юрист / комплаенс /
└────────┬─────────┘  госсектор / legal tech
         │
┌────────┼─────────┐
...
Career-ops поддерживает ключевые российские джоб-борды и юридические карьерные каналы:

| Площадка              | URL                                 | Тип       | Особенности                                                          |
| ---------------------- | ------------------------------------ | --------- | --------------------------------------------------------------------- |
| **HeadHunter**         | [hh.ru](https://hh.ru)               | API + Web | Главная площадка РФ, включая категорию «Юристы, юридический отдел». Открытый API |
| **Работа в России**    | [trudvsem.ru](https://trudvsem.ru)   | API + Web | Госпортал Роструда — в т.ч. вакансии в госорганах. Открытый API       |
| **Rabota.ru**          | [rabota.ru](https://rabota.ru)       | Web       | Принадлежит Сберу. Крупные компании, банки, финтех — комплаенс/юридический |
| **Superjob**           | [superjob.ru](https://www.superjob.ru) | Web     | Вторая по величине после hh.ru                                        |
| **Право.ру**           | [pravo.ru](https://pravo.ru)         | Web       | Юридические новости, вакансии, рейтинг Право-300                      |
| **Legal Insight**      | [legalinsight.ru](https://legalinsight.ru) | Web  | Юридическое издание — обзоры рынка, карьерные материалы               |

**Дополнительно:** мониторинг профильных юридических Telegram-каналов и чатов помогает закрыть слепые зоны сканера — уточняйте актуальные каналы в вашем регионе/практике, подборки быстро меняются.

### Особенности российского рынка в оценке

- **Квалификация**: юрист (профильный диплом, без обязательного экзамена для большинства работы) vs адвокат (адвокатский экзамен + членство в адвокатской палате) — статус адвоката нужен для защиты по уголовным делам и части судебного представительства
...
- **Комплаенс**: одно из наиболее быстрорастущих направлений, особенно в банках и финтехе (требования ЦБ РФ, антиотмывочное законодательство 115-ФЗ)
...
**Boards:** USAJOBS (госсектор США), GoInhouse, Lawjobs, LawCrossing, LateralHub, ABA и bar-association career centers

**🇷🇺 Россия:** Добавьте вручную в `portals.yml`: hh.ru (доминирующая площадка, включая юридические вакансии), trudvsem.ru (госпортал Роструда), rabota.ru, Superjob — используйте структуру `templates/portals.example.yml` как образец формата (готовых RU-записей в шаблоне нет). Право.ру и Legal Insight публикуют вакансии и обзоры рынка, но не дают открытого API для автоматического сканирования — используйте их вручную для поиска и контекста.
