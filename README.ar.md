...
> **هذه النسخة موجّهة للمسارات القانونية ومهنة المحاماة** -- محامو مكاتب المحاماة، المستشارون القانونيون الداخليون (in-house)، مستشارو الامتثال والشؤون التنظيمية، محامو القطاع الحكومي والصالح العام، وأدوار التقنية القانونية. الأنماط الوظيفية (archetypes)، قائمة بوابات التوظيف، مصادر أبحاث الرواتب، وبوابات التقييم الحاسمة (الترخيص/القيد المهني، مطابقة سنوات الخبرة بعد التأهيل PQE، تعارض المصالح) أدناه مضبوطة لتناسب سوق العمل القانوني. المحرك الأساسي للنظام محايد تماماً تجاه المسار المهني وقابل للتخصيص الكامل لأي مسار وظيفي آخر — فقط اطلب من وكيل الذكاء الاصطناعي الخاص بك تغيير الأنماط الوظيفية. النسخة الأصلية الموجهة لمسارات الذكاء الاصطناعي والهندسة التي بُني عليها هذا المشروع لا تزال مفتوحة المصدر ويصونها [santifer](https://santifer.io) (راجع "عن المطوّر" أدناه).
...
| **ماسح بوابات التوظيف** | معد مسبقاً لأكثر من 45 شركة/جهة -- تقنية قانونية (Harvey, Ironclad, Spellbook, EvenUp, Everlaw, Clio...)، شؤون قانونية داخلية بشركات تقنية (Anthropic, OpenAI, Coinbase, Databricks, Stripe...)، بالإضافة إلى بوابات حكومية (USAJOBS) ونقابات المحاماة -- مع استعلامات مخصصة |
...
تلصق رابط الوظيفة أو تفاصيلها
         ...
         ▼
┌──────────────────┐
│  تحديد النمط     │  التصنيف: محامٍ بمكتب محاماة (معاملات/تقاضٍ) /
│  (Archetype)     │  مستشار داخلي / امتثال / حكومي / تقنية قانونية
└────────┬─────────┘
         │
┌────────▼─────────┐
...
يحتوي الفاحص التلقائي على **أكثر من 45 شركة/جهة** مهيأة للفحص المباشر والسريع، مع **19 استعلام بحث** عبر منصات التوظيف الرئيسية. يمكنك نسخ وتخصيص إعداداتك الخاصة عبر `portals.yml`.

**التقنية القانونية (Legal tech):** Harvey، Ironclad، Spellbook، EvenUp، Everlaw، Rocket Lawyer، Filevine، Clio، Relativity، Luminance
**الشؤون القانونية الداخلية (In-house legal):** Anthropic، OpenAI، Coinbase، Figma، Brex، Databricks، Ramp، Notion، Perplexity، Stripe
**بوابات (Boards):** USAJOBS (القطاع الحكومي الفيدرالي الأمريكي)، GoInhouse، Lawjobs، LawCrossing، LateralHub، مراكز التوظيف التابعة لـ ABA ونقابات المحاماة بالولايات الأمريكية

> **ملاحظة حول السوق العربي والخليجي:** القوائم أعلاه موروثة من النسخة الأصلية (أمريكية بشكل أساسي) ولا تغطي بوابات التوظيف الإقليمية (مثل Bayt.com وGulfTalent وLaimoon ومجالس نقابات المحاماة العربية). أضِف بوابات ومصادر إقليمية خاصة بك عبر `portals.yml` — اطلب من وكيلك المساعدة في ذلك.
