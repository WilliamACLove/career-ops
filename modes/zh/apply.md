...
## 步骤 3.5 — 猎头渠道核查（防止"简历撞车"）

在为**律所岗位**起草任何直投（direct application）材料之前，先核查该雇主是否已有猎头在对接：查看 `config/profile.yml` → `legal.recruiter_channel.engagements`，以及 `data/applications.md` 中该公司对应行是否已带有 `via=` 标记。

- 律所招聘行业惯例是由首个提交候选人简历的猎头享有该候选人的推荐权，保护期以猎头与律所的合作协议为准（常见 3-6 个月，部分协议可达 6-12 个月）。若候选人已由猎头提交或猎头正在对接该律所，在猎头提交材料之上再走官网/内推直投，容易引发猎头费用纠纷——律所处理这类"简历撞车"最常见的做法是直接放弃候选人资格。
- 检测到猎头渠道存在（或可能存在）时：**停止起草，先向候选人提示**："{公司} 似乎已有猎头（{猎头名称，如已知}）在对接，或曾经对接过。直接投递可能导致简历撞车、猎头费用纠纷，甚至候选人资格被取消。建议通过该猎头渠道推进，或请候选人明确确认愿意承担风险后再直投。" 未获得候选人明确答复前，不生成或填写任何表单内容。
- 公司法务、合规及政府/公职律师岗位通常默认直投，此项核查只在猎头渠道确实存在时触发。
